...
export declare const No: (value: string) => "user-select: none;-ms-user-select: none;-moz-user-select: none;-khtml-user-select: none;-webkit-user-select: none;-webkit-touch-callout: none;" | "user-drag: none;-o-user-drag: none;-moz-user-drag: none;-khtml-user-drag: none;-webkit-user-drag: none;" | "outline: none;" | "border: none;" | "overflow: clip;" | "text-decoration: none;" | "box-shadow: 0 0 #0000;" | "filter: drop-shadow(0 0 #0000);" | null;
